...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, (int) DisplayUtil.dip2px(0f));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = (int) DisplayUtil.dip2px(DEF_DRAW_SIZE);
