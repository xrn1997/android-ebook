...
public class ReadBookControl {
    ...
    private final SPUtils preference;
    ...
    private ReadBookControl() {
        if (null == textKind) {
            ...
            temp1.put("textExtra", (int) DisplayUtil.dip2px(6.5f));
            textKind.add(temp1);

            Map<String, Integer> temp2 = new HashMap<>();
            temp2.put("textSize", 16);
            temp2.put("textExtra", (int) DisplayUtil.dip2px(8));
            textKind.add(temp2);

            Map<String, Integer> temp3 = new HashMap<>();
            temp3.put("textSize", 17);
            temp3.put("textExtra", (int) DisplayUtil.dip2px(9));
            textKind.add(temp3);

            Map<String, Integer> temp4 = new HashMap<>();
            temp4.put("textSize", 20);
            temp4.put("textExtra", (int) DisplayUtil.dip2px(11));
            textKind.add(temp4);

            Map<String, Integer> temp5 = new HashMap<>();
            temp5.put("textSize", 22);
            temp5.put("textExtra", (int) DisplayUtil.dip2px(13));
            textKind.add(temp5);

            Map<String, Integer> temp6 = new HashMap<>();
            temp6.put("textSize", 24);
            temp6.put("textExtra", (int) DisplayUtil.dip2px(15));
            textKind.add(temp6);

            Map<String, Integer> temp7 = new HashMap<>();
            temp7.put("textSize", 26);
            temp7.put("textExtra", (int) DisplayUtil.dip2px(17));
            textKind.add(temp7);

            Map<String, Integer> temp8 = new HashMap<>();
            temp8.put("textSize", 30);
            temp8.put("textExtra", (int) DisplayUtil.dip2px(21));
            textKind.add(temp8);
        }
