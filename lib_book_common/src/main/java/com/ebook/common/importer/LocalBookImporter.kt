    ...
    suspend fun import(source: File): LocBookShelfEntity =
        withContext(Dispatchers.IO) {
            ...
            try {
                ...
                val coverUrl = bookStore.bookDir(BookLocation(md5, format, BookShelfEntity.LOCAL_TAG))
                ...
                try {
                    ...
                    bookStore.deleteBook(BookLocation(md5, format, BookShelfEntity.LOCAL_TAG))
                    throw t
                }
