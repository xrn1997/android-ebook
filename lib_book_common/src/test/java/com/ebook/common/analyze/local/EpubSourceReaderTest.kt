...
class EpubSourceReaderTest {
    ...
    private val location = BookLocation(bookId, BookFormat.EPUB, BookShelfEntity.LOCAL_TAG)
    ...
    private fun sink(bookId: String) = object : ChapterSink {
        override suspend fun write(index: Int, paragraphs: List<String>): String {
            store.writeChapter(BookLocation(bookId, BookFormat.EPUB, BookShelfEntity.LOCAL_TAG), index, paragraphs)
